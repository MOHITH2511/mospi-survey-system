                    ...
                    return (
                      <SidebarMenuItem key={item.to}>
                        <SidebarMenuButton
                          ...
                          className={`h-14 px-5 group-data-[collapsible=icon]:px-0 group-data-[collapsible=icon]:justify-center transition-all duration-300 rounded-lg !bg-transparent hover:!bg-transparent data-[active=true]:!bg-transparent hover:translate-x-1 ${isActive
                              ? "!text-white font-bold drop-shadow-md"
                              : "!text-white/90 hover:!text-white font-medium"
                            }`}
                        >
                          <item.icon
                            className="shrink-0 transition-all group-data-[collapsible=icon]:mr-0 mr-4 h-6 w-6 group-data-[collapsible=icon]:h-6 group-data-[collapsible=icon]:w-6"
              ...
              <SidebarGroupContent>
                <SidebarMenu className="gap-2 px-2">
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      tooltip="Settings"
                      className="h-14 px-5 group-data-[collapsible=icon]:px-0 group-data-[collapsible=icon]:justify-center !bg-transparent hover:!bg-transparent data-[active=true]:!bg-transparent !text-white/90 hover:!text-white hover:translate-x-1 transition-all duration-300 font-medium rounded-lg"
                    >
                      <Settings className="shrink-0 transition-all group-data-[collapsible=icon]:mr-0 mr-4 h-6 w-6 group-data-[collapsible=icon]:h-6 group-data-[collapsible=icon]:w-6" />
                      <span className="text-[1.1rem]">Portal Settings</span>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                </SidebarMenu>
              </SidebarGroupContent>
            ...
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  className="h-14 px-5 group-data-[collapsible=icon]:px-0 group-data-[collapsible=icon]:justify-center !bg-transparent hover:!bg-transparent data-[active=true]:!bg-transparent !text-red-400 hover:!text-red-300 hover:translate-x-1 transition-all duration-300 font-bold rounded-lg"
                >
                  <LogOut className="shrink-0 transition-all group-data-[collapsible=icon]:mr-0 mr-4 h-6 w-6 group-data-[collapsible=icon]:h-6 group-data-[collapsible=icon]:w-6" strokeWidth={2.5} />
                  <span className="text-[1.1rem]">Sign Out</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
            </SidebarMenu>
          </SidebarFooter>
            ...
            <div className="ml-auto flex items-center gap-5">
              ...
              <div className="flex items-center gap-3">
                <div className="text-right hidden md:block">
                  <p className="text-sm font-bold text-gray-900">Official User</p>
