            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-1 group-hover:text-emerald-700 transition-colors">
                  Agricultural households increased 12%
                </h3>
                <p className="text-sm text-gray-600 leading-relaxed">
                  Based on the Q1 National Economic Survey, the proportion of households relying primarily on agriculture in the North Zone has increased compared to the previous census.
                </p>
                <div className="mt-3 flex items-center text-xs font-bold text-[#2563eb]">
                  View Dataset <ArrowRight className="h-3 w-3 ml-1" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-1 group-hover:text-[#2563eb] transition-colors">
                  Southern region response rate exceeds average
                </h3>
                <p className="text-sm text-gray-600 leading-relaxed">
                  Participation in Tamil Nadu and Kerala is currently 18% higher than the national baseline. Audio-responses account for 45% of these submissions.
                </p>
                <div className="mt-3 flex items-center text-xs font-bold text-[#2563eb]">
                  View Regional Report <ArrowRight className="h-3 w-3 ml-1" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-1 group-hover:text-amber-700 transition-colors">
                  Health survey participation is low in urban districts
                </h3>
                <p className="text-sm text-gray-600 leading-relaxed">
                  Tier-1 urban districts are showing a 22% drop-off rate in Section 4 of the Rural Health Assessment. The "Chronic Illness" matrix question is taking &gt;4 minutes to complete.
                </p>
                <div className="mt-3 flex items-center text-xs font-bold text-amber-600">
                  Investigate Anomaly <ArrowRight className="h-3 w-3 ml-1" />
                </div>
              </div>
            </div>
          </div>
