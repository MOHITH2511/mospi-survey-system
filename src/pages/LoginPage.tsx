...
export default function LoginPage() {
  ...
  const handleCitizenGetOTP = (e: React.FormEvent) => {
    e.preventDefault();
                ...
                {otpStep === "phone" ? (
                  <form onSubmit={handleCitizenGetOTP} className="space-y-6">
                    ...
                    <div className="pt-2">
                      <button
                        type="submit"
                        className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#004e8c] py-3.5 text-sm font-bold text-white shadow-md transition-all hover:bg-[#003366] hover:shadow-lg hover:-translate-y-0.5"
                      >
                        Generate OTP
                      </button>
                    </div>
