...
const alertsData = [
  { district: "Bengaluru Urban", metric: "Very Fast Completion (Speeding)", value: "14% of PLFS household rosters completed in < 90 seconds (FSU #2844)", severity: "high" },
  { district: "Mysuru", metric: "Invalid GPS Location coordinates", value: "8 enumerators recorded submissions outside assigned village boundaries", severity: "high" },
  { district: "Chennai", metric: "Duplicate Aadhaar/Mobile Submissions", value: "24 duplicate citizen tokens flagged in HCES round 78", severity: "high" },
  { district: "Madurai", metric: "Abnormal Numeric Outlier values", value: "Monthly incomes of > ₹5,000,000 recorded in low-income agricultural stratum", severity: "medium" },
  { district: "Coimbatore", metric: "High Missing Response Rate", value: "Section C (Expenditure details) has 32% incomplete fields in FSU #3091", severity: "medium" }
];
